...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE writeup SET title=?, author=?, description=? WHERE id=?";
...
$sql = "SELECT title, author, description FROM writeup WHERE id=?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $id);
$stmt->execute();
$stmt->bind_result($title, $author, $description);
$stmt->fetch();
$stmt->close();
$conn->close();
?>
